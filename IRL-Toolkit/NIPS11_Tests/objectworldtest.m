...
test_params = struct('training_sample_lengths',32,'training_samples',8,...
...
mdp_params = {struct('n',n,'determinism',0.7,'seed',0,'continuous',1)};
...
% Run transfer tests.
transfer_result = [];  
%runtransferseries(algorithms,series_result,...
